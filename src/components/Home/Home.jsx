        ...
        <Row className="justify-content-center">
          ...
          <Col xs={12} md={4} className="text-center mb-4 mb-md-0">
            <div className="profile-container">
              ...
              />
              <h3 className="profile-name">David H Smith IV</h3>
          ...
          <Col xs={12} md={8} className="bio bio-alignment">
            <div className="research-intro mb-4">
              <h4 className="mb-3">Research Vision</h4>
              <p>
              ...
              <Card className="mb-4 research-card">
                <Card.Body>
                  <Row className="align-items-center">
                    ...
                    <Col xs={12} sm={9} md={9} lg={10}>
                      <h5 className="research-title">Instructing Novice Programmers in Human-GenAI Collaborative Coding</h5>
                      <p className="research-text">
              ...
              <Card className="mb-4 research-card">
                <Card.Body>
                  <Row className="align-items-center">
                    ...
                    <Col xs={12} sm={9} md={9} lg={10}>
                      <h5 className="research-title">Scaling Assessment through Computer Based Testing</h5>
                      <p className="research-text">
